...
class ProductModelAdmin(admin.ModelAdmin):
    ...
    def contents(self, obj):
        return format_html(f'<span>{obj.description[:80]}</span>')  # slice character of cotent - useing html for styleing
    ...
    def edit_product(self, obj):
        return format_html(f'<a href="/admin/app/product/{obj.id}/change/">edit</a>') 
